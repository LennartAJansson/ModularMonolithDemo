namespace EmployeesApi.Infrastructure.Observability;
...
public static class ObservabilityExtensions
{
    ...
    {
        public WebApplicationBuilder AddEmployeesApiObservability()
        {
            string serviceName = "EmployeesApi";
            ...
            builder.Services.AddOpenTelemetry()
                .ConfigureResource(resource => resource
                    ...
                    .AddAttributes([
                        ...
                        new KeyValuePair<string, object>("service.namespace", "EmployeesApi")
                    ]))
            ...
            builder.Services.AddHealthChecks()
                .AddDbContextCheck<EmployeesDbContext>("database");
    ...
    {
        public WebApplication UseEmployeesApiObservability()
        {
