namespace WorkloadsApi.Infrastructure.Observability;
...
public static class ObservabilityExtensions
{
    ...
    {
        public WebApplicationBuilder AddWorkloadsApiObservability()
        {
            string serviceName = "WorkloadsApi";
            ...
            builder.Services.AddOpenTelemetry()
                .ConfigureResource(resource => resource
                    ...
                    .AddAttributes([
                        ...
                        new KeyValuePair<string, object>("service.namespace", "WorkloadsApi")
                    ]))
            ...
            builder.Services.AddHealthChecks()
                .AddDbContextCheck<WorkloadsDbContext>("database");
    ...
    {
        public WebApplication UseWorkloadsApiObservability()
        {
